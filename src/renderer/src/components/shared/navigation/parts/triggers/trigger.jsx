...
const Trigger = function ({ label, href, children }) {
  ...
  return (
    <Tabs.Trigger
      className="w-11 h-11 flex center rounded-2xl hover:rounded-3xl bg-accents-5 text-xl text-accents-7 hover:text-sand-12 overflow-hidden cursor-pointer transition-all duration-200 ease-in-out data-[state=active]:bg-[#FF6536] data-[state=active]:text-white"
      value={label}
      asChild
    >
