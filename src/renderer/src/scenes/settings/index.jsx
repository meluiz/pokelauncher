...
export const Settings = function () {
  ...
  return (
    <Tabs.Content
      className="tab-content w-full h-auto px-4 py-8"
      value="settings"
      forceMount
    >
        ...
        <div className="w-full max-w-sm space-y-12">
          <section className="space-y-8">
            <div className="space-y-2">
              ...
              <p className="text-sand-9 text-lg">
                Escolha uma conta para acessar o servidor
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-4">
                <p className="text-sand-10">
                  Ajuste a alocação de RAM para o seu jogo, pois uma quantidade
                  maior resultará em um melhor desempenho.
                </p>
                <p className="text-sand-10">
                  <strong className="text-sand-11">RAM Mínima:</strong> Indica a
                  quantidade mínima de RAM alocada ao iniciar o jogo. É
                  recomendado não alocar mais de 3GB para esse valor. O valor
                  padrão é 1GB.
                </p>
                <p className="text-sand-10">
                  <strong className="text-sand-11">RAM Máxima:</strong> Indica a
                  quantidade total de RAM alocada para o jogo. Recomenda-se não
                  ultrapassar 50% da quantidade total de RAM disponível em seu
                  PC para garantir um funcionamento adequado.
                </p>
              </div>
